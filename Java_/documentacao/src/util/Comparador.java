...
public class Comparador {
	...
	public static void main(String[] args) {
		...
		// Compara seus dois argumentos para ordem.
		//System.out.println(teste.compare(alunoM1, alunoA5));
		
		// Indica se algum outro objeto é "igual a" este comparador.
		//System.out.println(alunoA1.equals(alunoA5));
		
		// Retorna um comparador que impõe a ordem inversa deste comparador.
		//System.out.println(alunoA1.reversed());
		
		// Retorna um comparador de ordem lexicográfica com outro comparador.
		//System.out.println(alunoJ4.thenComparing(alunoD3));
		
		Collections.sort(aluno, new Comparator<Aluno>() {
			@Override
