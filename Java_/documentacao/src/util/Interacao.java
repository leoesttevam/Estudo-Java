...
public class Interacao {
	...
	public static void main(String[] args) {
		...
		// Abaixo está um programa simples que mostra como você iria iterar 
		// uma lista usando um iterador antes do Java 8.
		// System.out.println("Usando interator");
		//Iterator<Aluno> alunos = aluno.iterator();
		...
		// Abaixo está o mesmo exemplo mostrado acima,
		// mas desta vez, estamos usando o método forEachRemaining().
		Iterator<Aluno> al = aluno.iterator();
		
		al.forEachRemaining((a) -> System.out.println(aluno));
